        ...
        <div className="bg-gray-200 min-h-screen flex justify-center items-center">
            <div className="bg-white w-full max-w-2xl mx-auto p-5 shadow-lg rounded-lg text-center">
                ...
                <div className="flex flex-col items-center bg-white relative min-h-screen">
                    <h1 className="text-2xl font-extrabold mb-6 mt-5" style={{color: "#326807"}}>¡TU SUSCRIPCIÓN</h1>
                    ...
                    <div className="flex space-x-4">
                        <a href="https://play.google.com/store" target="_blank" rel="noopener noreferrer">
                            <img src="/src/img/google_play.png" alt="Google Play" className="w-32 h-auto" />
                        </a>
                        <a href="https://apps.apple.com/store" target="_blank" rel="noopener noreferrer">
                            <img src="/src/img/app_store.png" alt="App Store" className="w-32 h-auto" />
                        </a>
                    </div>
                </div>
            </div>
